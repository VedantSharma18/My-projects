...
#JUST TAKING NAMES OF FILES WHICH THE USER WANTS TO SAVE AS
input_video = input("Enter your file name for input video to be sent for  object detection using YOLO V3 :")
temp = input_video
input_video = "C:\\Users\\VEDANT\\Desktop\\Programming\\PYTHON\\YOLO\\videos\\"+temp+'.mp4'
result_video = input("Enter your file name for resultant video after object detection using YOLO V3 :")
temp = result_video
result_video ="C:\\Users\\VEDANT\\Desktop\\Programming\\PYTHON\\YOLO\\videos\\"+temp+'.mp4'
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter(result_video, resultVideo, 30,
